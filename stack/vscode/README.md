...
* The `update` command of Mac Stack will restore (overwrite) your IDE user settings and keybindings from the backup if `restore_ide_settings` is set `true` in the [macstack.json](../macstack.json) file.
