...
* The `update` command of Mac Stack will restore (overwrite) your IDE user settings and keybindings from the backup if `vscode_settings_restore` is set `true` in the [macstack.json](../macstack.json) file.
